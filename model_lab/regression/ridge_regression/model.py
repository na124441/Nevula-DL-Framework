"""
Experimental Ridge Regression Prototype.
...
class ExperimentalRidgeRegression(Module):
    """
    Experimental prototype of Ridge Regression using elementary matrix operations.
    """
