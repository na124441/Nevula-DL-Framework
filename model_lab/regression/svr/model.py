"""
Experimental Support Vector Regression Prototype.
...
class ExperimentalSVR(Module):
    """
    Experimental prototype of Support Vector Regression using elementary tensor operations.
    """
